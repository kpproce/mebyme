...
const  ChangeSliderVisibility_to_noShow = (props) => {
    ...
    const handleClick_visibilityChange_button = (aspect, bijInvoerTonen, action) => {
      ...
      props.callBack_changeSliderVisibility_to_noShow(true);
    }
  ...
  ChangeSliderVisibility_to_noShow.propTypes = {
    ...
    callBack_changeSliderVisibility_to_noShow : propTypes.func
  }
  
  export default ChangeSliderVisibility_to_noShow; 